...
save_direc = home_direc + '/../../../../../../ModelData/goehring_kant_koff_low_kon/'
...
BaseM = Model(Da=0.1, Dp=0.1, konA=0.01, koffA=0.01, konP=0.01, koffP=0.0101, kAP=0.001, kPA=0.001,
...
ParamSpace2D(func, p1_range=p1_range, p2_range=p2_range, cores=32, resolution0=11, resolution_step=2,
             n_iterations=4, direc=save_direc + sys.argv[1], parallel=True, replace=True).run()
